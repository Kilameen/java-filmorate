...
public class FilmDbStorage implements FilmStorage {
    ...
    private static final String SELECT_ALL_FILMS_SQL = "SELECT f.*, r.rating_name, r.rating_id, COUNT(fl.user_id) AS rate, d.director_id, d.name AS director_name,g.genre_id,g.genre_name\n" +
            ...
            "ORDER BY f.film_id;";
    private static final String SELECT_FILM_BY_ID_SQL = "SELECT f.*, r.rating_name, r.rating_id, COUNT(fl.user_id) AS rate, d.director_id, d.name AS director_name,g.genre_id,g.genre_name\n" +
            "FROM films AS f\n" +
            ...
            "GROUP BY f.film_id, r.rating_id, r.rating_name, d.director_id, d.name,g.genre_id,g.genre_name";
    private static final String SELECT_POPULAR_FILMS_SQL = "SELECT f.*, r.rating_name, r.rating_id, COUNT(fl.user_id) AS rate, d.director_id, d.name AS director_name,g.genre_id,g.genre_name\n" +
            ...
            "LEFT JOIN films_directors AS fd ON f.film_id = fd.film_id\n" +
            "LEFT JOIN directors AS d ON fd.director_id = d.director_id\n" +
            "GROUP BY f.film_id, r.rating_id, r.rating_name,g.genre_id,g.genre_name\n" +
